...
public class Compounder {
    ...
    private boolean initMuxer() {
        try {
            if((mVideoFormat = MediaUtils.getMediaFormat(mVideoExtractor, MediaUtils.MediaType.Video, mVideoPath)) != null) {
                ...
                if(mAudioDEType == NOT_DC_EC_TYPE){
                    MediaFormat audioFormat = MediaUtils.getMediaFormat(mAudioExtractor, MediaUtils.MediaType.Audio, mAudioPath);
                    if(audioFormat != null) {
    ...
    private boolean initDecodeAudio() {
        try {
            mAudioFormat = MediaUtils.getMediaFormat(mAudioExtractor, MediaUtils.MediaType.Audio, mAudioPath);
